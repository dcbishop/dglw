...
# NOTE: This is the timestamp from the time cmake was run, not compile time...

macro(DATETIME RESULT)
    if(WIN32)
        # [NOTE]: Windows has a differnt date format to everything else and will
        #         probably change the date/time format depending on the
        #         internationalization settings. Possible work around would be
        #         to use a vbs script via cscript.exe.
